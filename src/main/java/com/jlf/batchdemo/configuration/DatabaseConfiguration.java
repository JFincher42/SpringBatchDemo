...
public class DatabaseConfiguration {
    ...
    @Bean
    @Primary
    // The @Primary annotation is used to assign in higher preference to the annotated bean during
    // bean injection when the class has multiple beans of same time
    // In this case we have two beans of the DataSource type.
    ...
    @BatchDataSource
    // @BatchDataSource annotation is used to specify that this bean will be used
    // as the data source for the ItemReader during Batch Processing
